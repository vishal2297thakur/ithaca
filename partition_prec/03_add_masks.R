...
prec_masks[grepl("Dry Broadleaf Forests", biome_class) == TRUE, biome_short_class := "S/T Forests"]
prec_masks[grepl("Moist Broadleaf Forests", biome_class) == TRUE, biome_short_class := "S/T Forests"]
prec_masks[grepl("Subtropical Coniferous Forests", biome_class) == TRUE, biome_short_class := "S/T Forests"]
...
prec_masks[grepl("Subtropical Grasslands", biome_class) == TRUE, biome_short_class := "S/T Grasslands"]
