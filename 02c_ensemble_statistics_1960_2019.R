...
## Read data 
prec_1960_2019 <- lapply(prec_fnames_1960_2019_kenya, brick)
names(prec_1960_2019) <- prec_fnames_short_1960_2019_kenya 

prec_1960_2019 <- prec_1960_2019[c('cru-ts', 'era5', 'em-earth', 'gpcc', 'precl')] #pilot study
