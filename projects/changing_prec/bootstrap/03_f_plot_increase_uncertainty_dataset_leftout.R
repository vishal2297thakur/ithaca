...
## read data ----
# Input generated in changing_prec/bootstrap/02_d
land_cover_uncertainty <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_d_land_cover_uncertainty_dataset_leftout_bootstrap.rds"))
biome_uncertainty <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_d_biome_uncertainty_dataset_leftout_bootstrap.rds"))
elev_uncertainty <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_d_elev_uncertainty_dataset_leftout_bootstrap.rds"))
ipcc_uncertainty <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_d_ipcc_uncertainty_dataset_leftout_bootstrap.rds"))
KG_3_uncertainty <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_d_KG_3_uncertainty_dataset_leftout_bootstrap.rds"))
...
ggsave(paste0(PATH_SAVE_CHANGING_PREC_FIGURES, "03_f_box_land_cover_increase_uncertainty.png"), 
       width = 8, height = 3)
...
b <- ggplot(biome_uncertainty, aes(x = reorder(dataset_leftout, -ratio_area_fraction), y = ((ratio_area_fraction - 1)*100)))+
  ...
  ggtitle("Biomes")+
  theme(axis.text.x = element_text(angle = 60, vjust = 1, hjust = 1))
ggsave(paste0(PATH_SAVE_CHANGING_PREC_FIGURES, "03_f_box_biome_increase_uncertainty.png"), 
       width = 8, height = 3)
...
ggsave(paste0(PATH_SAVE_CHANGING_PREC_FIGURES, "03_f_box_KG_3_increase_uncertainty.png"), 
       width = 8, height = 3)
