...
ipcc_data <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "02_b_ipcc_uncertainty_bootstrap.rds"))
...
ggsave(paste0(PATH_SAVE_CHANGING_PREC_FIGURES, "03_j_map_global_trends_by_ipcc_bootstrap.png"),
