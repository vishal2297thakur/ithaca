...
## Data ----
### Input Data generated in projects/changing_prec/bootstrap/01_e ----
prec_trend_indices <- readRDS(paste0(PATH_SAVE_CHANGING_PREC, "01_e_global_grid_uncertainty_dataset_leftout_bootstrap.rds"))
prec_trend_indices[, count_all:= sum(N_pos_theil_sen, N_neg_theil_sen, N_ins_pos_theil_sen, N_ins_neg_theil_sen, na.rm = T),.(lon,lat)]
prec_trend_indices <- prec_trend_indices[ count_all >= 132]
...
## Read uncertainty data from previous analysis from 02_c (seems from 02_b_ instead)----
...
## save data ----
saveRDS(land_cover_uncertainty, paste0(PATH_SAVE_CHANGING_PREC, "02_i_land_cover_probability_groups_dataset_leftout_N12_bootstrap.rds"))
saveRDS(biome_uncertainty, paste0(PATH_SAVE_CHANGING_PREC, "02_i_biome_probability_groups_dataset_leftout_N12_bootstrap.rds"))
saveRDS(elev_uncertainty, paste0(PATH_SAVE_CHANGING_PREC, "02_i_elev_probability_groups_dataset_leftout_N12_bootstrap.rds"))
saveRDS(ipcc_uncertainty, paste0(PATH_SAVE_CHANGING_PREC, "02_i_ipcc_probability_groups_dataset_leftout_N12_bootstrap.rds"))
saveRDS(KG_3_uncertainty, paste0(PATH_SAVE_CHANGING_PREC, "02_i_KG_3_probability_groups_dataset_leftout_N12_bootstrap.rds"))
