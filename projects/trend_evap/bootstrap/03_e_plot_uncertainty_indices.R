...
# Input data generated in trend_evap/bootstrap/02_b
...
ipcc_uncertainty <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "ipcc_uncertainty_bootstrap.rds"))
KG_3_uncertainty <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "KG_3_uncertainty_bootstrap.rds"))
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_land_cover_uncertainty_probabilty_bootstrap.png"), 
       width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_biome_uncertainty_probabilty_bootstrap.png"), 
       width = 12, height = 8)
...
ggplot(ipcc_uncertainty) +
  ...
  theme_light() +
  theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_ipcc_ref_region_uncertainty_probabilty_bootstrap.png"), 
       width = 12, height = 8)
