...
## Data ----
# Input data generated in trend_evap/bootstrap/02_f
land_cover_uncertainty <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "land_cover_probability_groups_dataset_leftout_N14_bootstrap.rds"))
biome_uncertainty <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "biome_probability_groups_dataset_leftout_N14_bootstrap.rds"))
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_global_probability_groups_probabilty_per_dataset_leftout_bootstrap.png"), 
       width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_land_cover_probability_groups_probabilty_per_dataset_leftout_bootstrap.png"), 
       width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_biome_probability_groups_probabilty_per_dataset_leftout_bootstrap.png"), 
       width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_ipcc_ref_region_probability_groups_probabilty_per_dataset_leftout_bootstrap.png"), 
       width = 12, height = 14)
...
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "bar_elevation_probability_groups_probabilty_per_dataset_leftout_bootstrap.png"), 
       width = 8, height = 6)
