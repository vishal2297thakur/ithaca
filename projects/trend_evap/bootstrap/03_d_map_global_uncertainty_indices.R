...
## Data ----
### Input data generated in trend_evap/bootstrap/01_d
evap_trend_lon_lat <- readRDS(paste0(PATH_SAVE_EVAP_TREND, "global_grid_slope_indices_opp_allowed_bootstrap.rds"))
...
ggplot(evap_trend_lon_lat[!is.na(DCI_theil_sen_brks)])+
  ...
  labs(fill = "DCI")+
  theme_bw()
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "map_evap_trend_grid_DCI_theil_sen_bootstrap.png"), 
       width = 12, height = 8)
...
ggplot(evap_trend_lon_lat)+
  ...
  scale_fill_manual(values = c("negative likely" = "darkblue", 
                               ...
                               "no trend" = "gray80"))+
  theme_bw()
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "map_evap_trend_probability_theil_sen_bootstrap.png"), 
       width = 12, height = 8)
...
ggplot(evap_trend_lon_lat)+
  ...
  labs(fill = "")+
  theme_bw()
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "map_evap_trend_uncertain_theil_sen_bootstrap.png"), 
       width = 12, height = 8)
