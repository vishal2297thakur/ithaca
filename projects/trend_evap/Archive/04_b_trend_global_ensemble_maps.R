...
ggplot(evap_trend_grid_ensemble)+
  ...
  theme_bw()
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "evap_ensemble_trend_theil_sen_significant.png"), 
       width = 12, height = 8)
...
ggplot(evap_trend_grid_ensemble)+
  ...
  scale_fill_manual(values = cols_grid_ensemble)+
  theme_bw()
ggsave(paste0(PATH_SAVE_EVAP_TREND_FIGURES, "evap_ensemble_trend_theil_sen.png"), 
       width = 12, height = 8)
