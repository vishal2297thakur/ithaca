...
gg_not_event <- ggplot(to_plot) +
  ...
  scale_color_manual(values = c('steelblue3', 'darkred', 'darkgreen', 'darkorange')) +
...
gg_waffle <- 
  ...
  scale_fill_manual(values = c('steelblue3', 'darkred', 'darkgreen', 'darkorange')) + 
  xlab("") +
  ylab("") +
  theme_linedraw() +
...
gg_not_event_mean <- gg_not_event + annotation_custom(sub_grob, xmin  = 1, xmax = 1.5, ymin = 1.05, ymax = 1.4)
...
sub_grob <- ggplotGrob(gg_waffle)
gg_event_mean <- gg_event + annotation_custom(sub_grob, xmin  = 2.6, xmax = 4.2, ymin = 1.1, ymax = 2.5)
...
sub_grob <- ggplotGrob(gg_waffle)
gg_not_event_sum <- gg_not_event + annotation_custom(sub_grob, xmin  = 1, xmax = 1.5, ymin = 1.05, ymax = 1.4)
...
sub_grob <- ggplotGrob(gg_waffle)
gg_event_sum <- gg_event + annotation_custom(sub_grob, xmin  = 2.6, xmax = 4.2, ymin = 1.1, ymax = 2.5)

ggarrange(gg_not_event_mean, gg_event_mean, gg_not_event_sum, gg_event_sum, 
          ncol = 2, nrow = 2,
          labels = c("A", "B", "C", "D"),
