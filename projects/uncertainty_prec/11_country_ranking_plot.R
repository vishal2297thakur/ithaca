...
data_levels <- rev(c("GPM-IMERG v7", "MSWEP v2.8", "PREC/L", "GPCP v3.2",
                     "MERRA-2", "EM-Earth", "CRU TS v4.06", "FLDAS",
                     "PERSIANN-CDR", "ERA5-Land", "TerraClimate", "CMAP",
                     "GPCC v2020", "GSMaP v8", "CPC-Global", "ERA5", "JRA-55",
