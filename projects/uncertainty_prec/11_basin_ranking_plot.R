...
data_levels <- rev(c("GPM-IMERG v7", "PREC/L", "EM-Earth", "GPCP v3.2",
                     "MSWEP v2.8", "MERRA-2", "CRU TS v4.06", "FLDAS",
                     "TerraClimate", "PERSIANN-CDR", "CPC-Global", "CMAP",
                     "ERA5-Land", "GSMaP v8", "GPCC v2020", "ERA5", "JRA-55",
