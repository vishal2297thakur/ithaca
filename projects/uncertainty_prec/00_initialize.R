...
## Data
PREC_NAMES_SHORT_2001_2019_FULL_RECORD <-  c("cmap", "cmorph", "cpc",
                                             "cru-ts", "em-earth", "era5",
                                             "era5-land", "fldas", "gpcc",
                                             "gpcp", "gpm-imerg", "gsmap",
                                             "jra55", "merra2", "mswep",
                                             "ncep-doe", "ncep-ncar",
                                             "persiann", "precl",
                                             "terraclimate")
...
PREC_NAMES_2001_2019_FULL_RECORD_MONTH <- grep("monthly",
                                               PREC_NAMES_2001_2019_FULL_RECORD,
                                               value = TRUE)

PREC_NAMES_2001_2019_FULL_RECORD_YEARS <- grep("yearly",
                                               PREC_NAMES_2001_2019_FULL_RECORD,
                                               value = TRUE)
## Save
save(PREC_NAMES_SHORT_2001_2019_FULL_RECORD,
     PREC_NAMES_2001_2019_FULL_RECORD_MONTH,
     PREC_NAMES_2001_2019_FULL_RECORD_YEARS,
