...
PREC_NAMES_2000_2019_FULL_RECORD_MONTH <- grep("monthly",
                                               PREC_NAMES_2000_2019_FULL_RECORD,
                                               value = TRUE)

PREC_NAMES_2000_2019_FULL_RECORD_YEARS <- grep("yearly",
                                               PREC_NAMES_2000_2019_FULL_RECORD,
                                               value = TRUE)

save(PREC_NAMES_SHORT_2000_2019_FULL_RECORD,
     PREC_NAMES_2000_2019_FULL_RECORD_MONTH,
     PREC_NAMES_2000_2019_FULL_RECORD_YEARS,
