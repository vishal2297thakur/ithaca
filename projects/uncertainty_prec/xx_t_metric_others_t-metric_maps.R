...
## Data
prec_month <- readRDS(paste0(PATH_SAVE_UNCERTAINTY_PREC, "t_metric_min.rds"))
...
ggsave(plot = p00,
       paste0(PATH_SAVE_UNCERTAINTY_PREC_FIGURES,
              "t-metric_maps_min.png"), width = 4.5*GOLDEN_RATIO*2, height = 4.5)

## Data
prec_month <- readRDS(paste0(PATH_SAVE_UNCERTAINTY_PREC, "t_metric_ncep.rds"))
...
ggsave(plot = p00,
       paste0(PATH_SAVE_UNCERTAINTY_PREC_FIGURES,
              "t-metric_maps_ncep.png"), width = 4.5*GOLDEN_RATIO*2, height = 4.5)
###

prec_month <- readRDS(paste0(PATH_SAVE_UNCERTAINTY_PREC, "t_metric_top10.rds"))
...
ggsave(plot = p00,
       paste0(PATH_SAVE_UNCERTAINTY_PREC_FIGURES,
              "t-metric_maps_top10.png"), width = 4.5*GOLDEN_RATIO*2, height = 4.5)

###

prec_month <- readRDS(paste0(PATH_SAVE_UNCERTAINTY_PREC, "t_metric_gpm.rds"))
...
ggsave(plot = p00,
       paste0(PATH_SAVE_UNCERTAINTY_PREC_FIGURES,
              "t-metric_maps_gpm.png"), width = 4.5*GOLDEN_RATIO*2, height = 4.5)
