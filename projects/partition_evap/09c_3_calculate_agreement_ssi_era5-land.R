...
## Dry ranked Data ----
evap_stats <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_dry_rank_ssi_era5-land.rds"))
evap_stats <- evap_stats[dataset_count > MIN_N_DATASETS]
...
### Save data ----
saveRDS(evap_stats, paste0(PATH_SAVE_PARTITION_EVAP, "evap_stats_ssi_era5-land_dry_rank.rds"))



## Wet Data ----
evap_stats <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_wet_rank_ssi_era5-land.rds"))
evap_stats <- evap_stats[dataset_count > MIN_N_DATASETS]
...
### Save data ----
saveRDS(evap_stats, paste0(PATH_SAVE_PARTITION_EVAP, "evap_stats_ssi_era5-land_wet_rank.rds"))
