# Dividing soil moisture data according to ssi based on terraclimate data----
source('source/partition_evap.R')

## Load data ----
ssi <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "ssi_200001_201912_terraclimate.rds"))
...
saveRDS(evap_ens_stats_dry, paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_dry_ssi_terraclimate.rds"))
...
saveRDS(evap_ens_stats_wet, paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_wet_ssi_terraclimate.rds"))
...
saveRDS(evap_ens_stats_normal, paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_normal_ssi_terraclimate.rds"))