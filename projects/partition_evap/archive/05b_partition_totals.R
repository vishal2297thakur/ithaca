...
### Figure 2
gg_fig_2_land <- ggarrange(fig_land_cover_partition_fraction,fig_biome_partition_fraction,
...
gg_fig_2_fin <- ggarrange(gg_fig_2_land, gg_ipcc,
                          common.legend = T, legend = 'right', 
                          nrow = 2, heights = c(0.7,1),
                          labels = c('', ''))

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "fig2_main_partition_fraction_agreement_rel_dataset_agreement.png"), width = 10, height = 10)

gg_fig_2_2 <- ggarrange(fig_elevation_partition_fraction, fig_evap_partition_fraction,
                        labels = c('a', 'b'), align = 'hv',
                        common.legend = T, legend = 'right', 
                        nrow = 1, ncol = 2)

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "fig2_SI_partition_fraction_agreement_rel_dataset_agreement.png"), width = 8, height = 5)
