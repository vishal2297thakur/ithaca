...
## Ranked Data ----
evap_stats_dry <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_dry_rank_ssi_era5-land.rds"))
evap_stats_wet <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_ensemble_stats_wet_rank_ssi_era5-land.rds"))
...
ggplot(evap_stats)+
  ...
  ggtitle("Ratio of standard quantile range")+
  theme_bw()
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "ratio_std_quantile_ssi_era5-land_dry_wet_rank.png"), 
       width = 16, height = 8)
