# Dividing soil moisture data according to ssi based on GPCC data----
...
## merge data ----
evap_datasets_ssi <- merge(evap_datasets, ssi, by.y =  c("x", "y", "year"), by.x = c("lon", "lat", "year"), all.x = TRUE)
