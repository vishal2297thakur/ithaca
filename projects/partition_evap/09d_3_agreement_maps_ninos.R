...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_el_nino.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_el_nino.png"), 
     width = 12, height = 12, res = 300, units = 'in')
gg_agreement
dev.off()

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "evap_quant_dataset_agreement_map_el_nino.png"), width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_la_nina.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_la_nina.png"), 
     width = 12, height = 12, res = 300, units = 'in')
gg_agreement
dev.off()

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "evap_quant_dataset_agreement_map_la_nina.png"), width = 12, height = 8)
...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_neutral.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_neutral.png"), 
     width = 12, height = 12, res = 300, units = 'in')
gg_agreement
dev.off()

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "evap_quant_dataset_agreement_map_neutral.png"), width = 12, height = 8)
