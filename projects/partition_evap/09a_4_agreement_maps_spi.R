...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_spi_dry.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_spi_dry.png"), 
...
evap_mask <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_stats_spi_wet.rds"))
levels(evap_mask$rel_dataset_agreement) <- c("High", "Above average", "Average",
                                             "Below average", "Low")
levels(evap_mask$evap_quant_dataset_agreement) <- c("High", "Above average", "Average",
                                                    "Below average", "Low")
...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_spi_wet.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_spi_wet.png"), 
     width = 12, height = 12, res = 300, units = 'in')
gg_agreement
dev.off()
...
evap_mask <- readRDS(paste0(PATH_SAVE_PARTITION_EVAP, "evap_stats_spi_normal.rds"))
levels(evap_mask$rel_dataset_agreement) <- c("High", "Above average", "Average",
                                             "Below average", "Low")
levels(evap_mask$evap_quant_dataset_agreement) <- c("High", "Above average", "Average",
                                                    "Below average", "Low")
...
ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "rel_dataset_agreement_map_spi_normal.png"), width = 12, height = 8)
...
jpeg(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES, "dataset_agreement_maps_spi_normal.png"), 
     width = 12, height = 12, res = 300, units = 'in')
gg_agreement
dev.off()

ggsave(paste0(PATH_SAVE_PARTITION_EVAP_FIGURES,
              "evap_quant_dataset_agreement_map_spi_normal.png"), width = 12, height = 8)
