...
land_cover_class <- merge(prec_mask[prec_quant_dataset_agreement == 'high', .(lat, lon, land_cover_short_class)], 
...
biome_class <- merge(prec_mask[prec_quant_dataset_agreement == 'high', .(lat, lon, biome_short_class)], 
                          prec_datasets_volume[, .(lon, lat, year, prec_volume, area, dataset, dataset_type)], 
                          by = c("lon", "lat"))
...
elev_class <- merge(prec_mask[prec_quant_dataset_agreement == 'high', .(lat, lon, elev_class)], 
                          prec_datasets_volume[, .(lon, lat, year, prec_volume, area, dataset, dataset_type)], 
                          by = c("lon", "lat"))
...
prec_class <- merge(prec_mask[prec_quant_dataset_agreement == 'high', .(lat, lon, prec_quant)], 
                          prec_datasets_volume[, .(lon, lat, year, prec_volume, area, dataset, dataset_type)], 
                          by = c("lon", "lat"))
...
write.csv(table_land_cover_class_mm, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_land_cover_conditioned_mm.csv"))
write.csv(table_land_cover_class_vol, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_land_cover_conditioned_vol.csv"))
...
write.csv(table_biome_class_mm, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_biome_conditioned_mm.csv"))
write.csv(table_biome_class_vol, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_biome_conditioned_vol.csv"))
...
write.csv(table_elev_class_mm, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_conditioned_elev_mm.csv"))
write.csv(table_elev_class_vol, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_conditioned_elev_vol.csv"))
...
write.csv(table_prec_class_mm, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_conditioned_prec_mm.csv"))
write.csv(table_prec_class_vol, paste0(PATH_SAVE_PARTITION_PREC_TABLES, "partition_conditioned_prec_vol.csv"))
