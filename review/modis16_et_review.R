...
# selects time
cdo_seltimestep_fnc(inputfile_name = fname, outputfile_name = "~/Review/mod16_review_sel.nc", start_time = start_time, end_time = end_time)

# Calculate field means
cdo_fldmean_fnc(inputfile_name = "~/Review/mod16_review_sel.nc", outputfile_name = "~/Review/mod16_review_fldmean_check.nc")

cdo_info_fnc(inputfile_name = "~/Review/mod16_review_fldmean_check.nc")

cdo_timmean_fnc(inputfile_name =  "~/Review/mod16_review_fldmean_check.nc", outputfile_name = "~/Review/mod16_fldmean_timmean_mean.nc")

cdo_info_fnc(inputfile_name = "~/Review/mod16_fldmean_timmean_mean.nc")
