...
fnames_product <- fnames_nc[grep("etsynthesis", fnames_nc)]
...
period_end <- as.Date("2009-01-01") 

start_time <- which(data@z$Date == period_start)
end_time <- which(data@z$Date == period_end)

cdo_seltimestep_fnc(inputfile_name = fname, outputfile_name = "~/Review/synthesiset_review_sel_i.nc", start_time = start_time, end_time = end_time)
cdo_fldmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_i.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc")
cdo_timmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean_timmean.nc")
cdo_info_fnc("~/Review/synthesiset_review_sel_fldmean_timmean.nc")

# period ii
period_start <- as.Date("2010-01-01") 
period_end <- as.Date("2019-01-01") 

start_time <- which(data@z$Date == period_start)
end_time <- which(data@z$Date == period_end)

cdo_seltimestep_fnc(inputfile_name = fname, outputfile_name = "~/Review/synthesiset_review_sel_ii.nc", start_time = start_time, end_time = end_time)
cdo_fldmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_ii.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc")
cdo_timmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean_timmean.nc")
cdo_info_fnc("~/Review/synthesiset_review_sel_fldmean_timmean.nc")
...
cdo_seltimestep_fnc(inputfile_name = fname, outputfile_name = "~/Review/synthesiset_review_sel_iii.nc", start_time = start_time, end_time = end_time)
cdo_fldmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_iii.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc")
cdo_timmean_fnc(inputfile_name = "~/Review/synthesiset_review_sel_fldmean.nc", outputfile_name = "~/Review/synthesiset_review_sel_fldmean_timmean.nc")
cdo_info_fnc("~/Review/synthesiset_review_sel_fldmean_timmean.nc")
