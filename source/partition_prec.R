...
## Paths
### Input - Raw data 
PREC_FNAMES_SHORT_2000_2019 <-  c("era5", "jra55", "merra2", "ncep-doe", "ncep-ncar", "chirps", 
...
PREC_FNAMES_2000_2019_FULL_RECORD <- unique(grep(paste(PREC_FNAMES_SHORT_2000_2019, collapse = "|"), 
